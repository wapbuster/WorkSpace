package com.indus.training.orm.dao.ui;
...
import com.indus.training.orm.dao.impl.MovieDAOImpl;
import com.indus.training.orm.domain.Movie;
import com.indus.training.orm.exception.IndusPersistException;
import com.indus.training.orm.exception.IndusUIException;
...
public class TestMovieDAOUI {
	...
	public static void main(String[] args) throws IndusUIException, IndusPersistException {
		...
		movieDao.deleteMovie(1686);
		
		movieObj.setMovieId(new Integer(1687));
		movieObj.setMovieName("Robo 4.4");
