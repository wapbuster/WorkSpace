...
public class Country implements Serializable {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((countryDetails == null) ? 0 : countryDetails.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (countryDetails == null) {
			if (other.countryDetails != null)
				return false;
		} else if (!countryDetails.equals(other.countryDetails))
			return false;
		if (country_id == null) {
