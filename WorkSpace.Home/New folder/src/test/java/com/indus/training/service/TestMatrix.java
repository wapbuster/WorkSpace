...
public class TestMatrix extends TestCase {
	...
	public void testSubtract() {
		double[][] param1 = { { 6.0, 8.0, 10.0 }, { 15.0, 14.0, 9.0 }, { 7.0, 6.0, 5.0, } };
		double[][] param2 = { { -4.0, 5.0, 3.0 }, { 5.0, 6.0, 3.0 }, { 3.0, 2.0, 1.0 } };
		double[][] expResult = { { 10.0, 3.0, 7.0 }, { 10.0, 8.0, 6.0 }, { 4.0, 4.0, 4.0 } };
		...
		// Actual Result
		MatrixOutput actMatrixOutput = matrixObj.subtract(matrixInObj);
