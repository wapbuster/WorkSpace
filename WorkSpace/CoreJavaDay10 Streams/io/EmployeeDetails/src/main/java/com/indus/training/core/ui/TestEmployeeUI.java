...
import com.indus.training.core.impl.Employee;
import com.indus.training.core.service.IEmployee;
...
public class TestEmployeeUI {
	...
	public static void main(String[] args) throws IndusException {
		...
		IEmployee empObj = new Employee();
		EmployeeDetails eDetailsObj = new EmployeeDetails();
